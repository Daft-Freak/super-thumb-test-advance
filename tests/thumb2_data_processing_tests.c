 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  3) , NO_SRC1, 0x7FFF8000, 0x00070000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00000000, 0x00000000, 0       , 0       },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00000000, 0x00000000, PSR_MASK, PSR_MASK},
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00000001, 0x00000001, 0       , 0       },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00007FFF, 0x0000007F, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00008000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x0000FFFF, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x00010000, 0x00010000, 0       , 0       },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x7FFF0000, 0x007F0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x80000000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0xFFFF0000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x0001FFFF, 0x00010000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0xFFFF0001, 0x00000001, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x7FFFFFFF, 0x007F0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0xFFFF7FFF, 0x0000007F, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x80007FFF, 0x0000007F, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0,  7) , NO_SRC1, 0x7FFF8000, 0x007F0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00000000, 0x00000000, 0       , 0       },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00000000, 0x00000000, PSR_MASK, PSR_MASK},
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00000001, 0x00000001, 0       , 0       },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00007FFF, 0x00003FFF, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00008000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x0000FFFF, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x00010000, 0x00010000, 0       , 0       },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x7FFF0000, 0x3FFF0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x80000000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0xFFFF0000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x0001FFFF, 0x00010000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0xFFFF0001, 0x00000001, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x7FFFFFFF, 0x3FFF0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0xFFFF7FFF, 0x00003FFF, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x80007FFF, 0x00003FFF, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 14) , NO_SRC1, 0x7FFF8000, 0x3FFF0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00000000, 0x00000000, 0       , 0       },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00000000, 0x00000000, PSR_MASK, PSR_MASK},
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00000001, 0x00000001, 0       , 0       },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00007FFF, 0x00007FFF, 0       , 0       },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00008000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x0000FFFF, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x00010000, 0x00010000, 0       , 0       },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x7FFF0000, 0x7FFF0000, 0       , 0       },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x80000000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0xFFFF0000, 0x00000000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x0001FFFF, 0x00010000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0xFFFF0001, 0x00000001, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x7FFFFFFF, 0x7FFF0000, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0xFFFF7FFF, 0x00007FFF, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x80007FFF, 0x00007FFF, 0       , FLAG_Q  },
    {OP(0xD,  2, 0,  0, 15) , NO_SRC1, 0x7FFF8000, 0x7FFF0000, 0       , FLAG_Q  },
#endif
};
...
#ifdef __ARM_FEATURE_DSP
    // SXTAH r0 r2 r1
    {OP(0x0, 0x8, 2, 0, 1), 0x12340000, 0x00000000, 0x00000000, 0              , 0       }, // 108
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB0000, 0x00000000, 0x00000000, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12340000, 0x00000001, 0x00000001, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB0000, 0xFFFFFFFF, 0xFFFFFFFF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12340000, 0x7FFFFFFF, 0x7FFFFFFF, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB0000, 0x80000000, 0x80000000, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x123400FF, 0x00000000, 0x000000FF, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB00FF, 0x00000000, 0x000000FF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x123400FF, 0x00000001, 0x00000100, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB00FF, 0xFFFFFFFF, 0x000000FE, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x123400FF, 0x7FFFFFFF, 0x800000FE, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB00FF, 0x80000000, 0x800000FF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12347FFF, 0x00000000, 0x00007FFF, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0x00007FFF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00008000, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0x00007FFE, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x80007FFE, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x80007FFF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12348000, 0x00000000, 0xFFFF8000, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB8000, 0x00000000, 0xFFFF8000, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12348000, 0x00000001, 0xFFFF8001, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB8000, 0xFFFFFFFF, 0xFFFF7FFF, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x8, 2, 0, 1), 0x12348000, 0x7FFFFFFF, 0x7FFF7FFF, 0              , 0       },
    {OP(0x0, 0x8, 2, 0, 1), 0x89AB8000, 0x80000000, 0x7FFF8000, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x9, 2, 0, 1), 0x12347FFF, 0x00000000, 0x0000347F, 0              , 0       },
    {OP(0x0, 0x9, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0xFFFFAB7F, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x9, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00003480, 0              , 0       },
    {OP(0x0, 0x9, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0xFFFFAB7E, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0x9, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x8000347E, 0              , 0       },
    {OP(0x0, 0x9, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x7FFFAB7F, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xA, 2, 0, 1), 0x12347FFF, 0x00000000, 0x00001234, 0              , 0       },
    {OP(0x0, 0xA, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0xFFFF89AB, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xA, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00001235, 0              , 0       },
    {OP(0x0, 0xA, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0xFFFF89AA, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xA, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x80001233, 0              , 0       },
    {OP(0x0, 0xA, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x7FFF89AB, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xB, 2, 0, 1), 0x12347FFF, 0x00000000, 0xFFFFFF12, 0              , 0       },
    {OP(0x0, 0xB, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0xFFFFFF89, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xB, 2, 0, 1), 0x12347FFF, 0x00000001, 0xFFFFFF13, 0              , 0       },
    {OP(0x0, 0xB, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0xFFFFFF88, PSR_MASK       , PSR_MASK},
    {OP(0x0, 0xB, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x7FFFFF11, 0              , 0       },
    {OP(0x0, 0xB, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x7FFFFF89, PSR_MASK       , PSR_MASK},
    
    // UXTAH r0 r2 r1
    {OP(0x1, 0x8, 2, 0, 1), 0x12340000, 0x00000000, 0x00000000, 0              , 0       }, // 150
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB0000, 0x00000000, 0x00000000, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12340000, 0x00000001, 0x00000001, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB0000, 0xFFFFFFFF, 0xFFFFFFFF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12340000, 0x7FFFFFFF, 0x7FFFFFFF, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB0000, 0x80000000, 0x80000000, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x123400FF, 0x00000000, 0x000000FF, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB00FF, 0x00000000, 0x000000FF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x123400FF, 0x00000001, 0x00000100, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB00FF, 0xFFFFFFFF, 0x000000FE, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x123400FF, 0x7FFFFFFF, 0x800000FE, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB00FF, 0x80000000, 0x800000FF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12347FFF, 0x00000000, 0x00007FFF, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0x00007FFF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00008000, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0x00007FFE, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x80007FFE, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x80007FFF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12348000, 0x00000000, 0x00008000, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB8000, 0x00000000, 0x00008000, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12348000, 0x00000001, 0x00008001, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB8000, 0xFFFFFFFF, 0x00007FFF, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x8, 2, 0, 1), 0x12348000, 0x7FFFFFFF, 0x80007FFF, 0              , 0       },
    {OP(0x1, 0x8, 2, 0, 1), 0x89AB8000, 0x80000000, 0x80008000, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x9, 2, 0, 1), 0x12347FFF, 0x00000000, 0x0000347F, 0              , 0       },
    {OP(0x1, 0x9, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0x0000AB7F, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x9, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00003480, 0              , 0       },
    {OP(0x1, 0x9, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0x0000AB7E, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0x9, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x8000347E, 0              , 0       },
    {OP(0x1, 0x9, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x8000AB7F, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xA, 2, 0, 1), 0x12347FFF, 0x00000000, 0x00001234, 0              , 0       },
    {OP(0x1, 0xA, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0x000089AB, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xA, 2, 0, 1), 0x12347FFF, 0x00000001, 0x00001235, 0              , 0       },
    {OP(0x1, 0xA, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0x000089AA, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xA, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x80001233, 0              , 0       },
    {OP(0x1, 0xA, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x800089AB, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xB, 2, 0, 1), 0x12347FFF, 0x00000000, 0x0000FF12, 0              , 0       },
    {OP(0x1, 0xB, 2, 0, 1), 0x89AB7FFF, 0x00000000, 0x0000FF89, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xB, 2, 0, 1), 0x12347FFF, 0x00000001, 0x0000FF13, 0              , 0       },
    {OP(0x1, 0xB, 2, 0, 1), 0x89AB7FFF, 0xFFFFFFFF, 0x0000FF88, PSR_MASK       , PSR_MASK},
    {OP(0x1, 0xB, 2, 0, 1), 0x12347FFF, 0x7FFFFFFF, 0x8000FF11, 0              , 0       },
    {OP(0x1, 0xB, 2, 0, 1), 0x89AB7FFF, 0x80000000, 0x8000FF89, PSR_MASK       , PSR_MASK},

    // SXTAB r0 r2 r1
    {OP(0x4, 0x8, 2, 0, 1), 0x12345600, 0x00000000, 0x00000000, 0              , 0       }, // 192
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD00, 0x00000000, 0x00000000, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x12345600, 0x00000001, 0x00000001, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABDC00, 0xFFFFFFFF, 0xFFFFFFFF, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x12345600, 0x7FFFFFFF, 0x7FFFFFFF, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD00, 0x80000000, 0x80000000, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234560F, 0x00000000, 0x0000000F, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD0F, 0x00000000, 0x0000000F, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234560F, 0x00000001, 0x00000010, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD0F, 0xFFFFFFFF, 0x0000000E, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234560F, 0x7FFFFFFF, 0x8000000E, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD0F, 0x80000000, 0x8000000F, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234567F, 0x00000000, 0x0000007F, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0x0000007F, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000080, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0x0000007E, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x8000007E, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x8000007F, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x12345680, 0x00000000, 0xFFFFFF80, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD80, 0x00000000, 0xFFFFFF80, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x12345680, 0x00000001, 0xFFFFFF81, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABDC80, 0xFFFFFFFF, 0xFFFFFF7F, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x8, 2, 0, 1), 0x12345680, 0x7FFFFFFF, 0x7FFFFF7F, 0              , 0       },
    {OP(0x4, 0x8, 2, 0, 1), 0x89ABCD80, 0x80000000, 0x7FFFFF80, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x9, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000056, 0              , 0       },
    {OP(0x4, 0x9, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0xFFFFFFCD, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x9, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000057, 0              , 0       },
    {OP(0x4, 0x9, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0xFFFFFFCC, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0x9, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000055, 0              , 0       },
    {OP(0x4, 0x9, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x7FFFFFCD, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xA, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000034, 0              , 0       },
    {OP(0x4, 0xA, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0xFFFFFFAB, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xA, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000035, 0              , 0       },
    {OP(0x4, 0xA, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0xFFFFFFAA, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xA, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000033, 0              , 0       },
    {OP(0x4, 0xA, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x7FFFFFAB, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xB, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000012, 0              , 0       },
    {OP(0x4, 0xB, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0xFFFFFF89, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xB, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000013, 0              , 0       },
    {OP(0x4, 0xB, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0xFFFFFF88, PSR_MASK       , PSR_MASK},
    {OP(0x4, 0xB, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000011, 0              , 0       },
    {OP(0x4, 0xB, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x7FFFFF89, PSR_MASK       , PSR_MASK},

    // UXTAB r0 r2 r1
    {OP(0x5, 0x8, 2, 0, 1), 0x12345600, 0x00000000, 0x00000000, 0              , 0       }, // 234
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD00, 0x00000000, 0x00000000, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x12345600, 0x00000001, 0x00000001, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABDC00, 0xFFFFFFFF, 0xFFFFFFFF, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x12345600, 0x7FFFFFFF, 0x7FFFFFFF, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD00, 0x80000000, 0x80000000, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234560F, 0x00000000, 0x0000000F, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD0F, 0x00000000, 0x0000000F, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234560F, 0x00000001, 0x00000010, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD0F, 0xFFFFFFFF, 0x0000000E, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234560F, 0x7FFFFFFF, 0x8000000E, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD0F, 0x80000000, 0x8000000F, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234567F, 0x00000000, 0x0000007F, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0x0000007F, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000080, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0x0000007E, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x8000007E, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x8000007F, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x12345680, 0x00000000, 0x00000080, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD80, 0x00000000, 0x00000080, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x12345680, 0x00000001, 0x00000081, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD80, 0xFFFFFFFF, 0x0000007F, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x8, 2, 0, 1), 0x12345680, 0x7FFFFFFF, 0x8000007F, 0              , 0       },
    {OP(0x5, 0x8, 2, 0, 1), 0x89ABCD80, 0x80000000, 0x80000080, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x9, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000056, 0              , 0       },
    {OP(0x5, 0x9, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0x000000CD, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x9, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000057, 0              , 0       },
    {OP(0x5, 0x9, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0x000000CC, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0x9, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000055, 0              , 0       },
    {OP(0x5, 0x9, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x800000CD, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0xA, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000034, 0              , 0       },
    {OP(0x5, 0xA, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0x000000AB, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0xA, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000035, 0              , 0       },
    {OP(0x5, 0xA, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0x000000AA, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0xA, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000033, 0              , 0       },
    {OP(0x5, 0xA, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x800000AB, PSR_MASK       , PSR_MASK},    
    {OP(0x5, 0xB, 2, 0, 1), 0x1234567F, 0x00000000, 0x00000012, 0              , 0       },
    {OP(0x5, 0xB, 2, 0, 1), 0x89ABCD7F, 0x00000000, 0x00000089, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0xB, 2, 0, 1), 0x1234567F, 0x00000001, 0x00000013, 0              , 0       },
    {OP(0x5, 0xB, 2, 0, 1), 0x89ABCD7F, 0xFFFFFFFF, 0x00000088, PSR_MASK       , PSR_MASK},
    {OP(0x5, 0xB, 2, 0, 1), 0x1234567F, 0x7FFFFFFF, 0x80000011, 0              , 0       },
    {OP(0x5, 0xB, 2, 0, 1), 0x89ABCD7F, 0x80000000, 0x80000089, PSR_MASK       , PSR_MASK},
#endif
};
...
#define OP(op, op2, rn, rdl, rdh, rm) (0xFB800000 | op << 20 | rn << 16 | rdl << 12 | rdh << 8 | op2 << 4 | rm)

static const struct TestInfo32LongMul mull_tests[] = {
    // SMULL r0 r3 r2 r1
    {OP(0, 0, 2, 0, 3, 1), 0x00000000, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000}, // 0
    {OP(0, 0, 2, 0, 3, 1), 0x00000000, 0x00000001, 0x0123456789ABCDEF, 0x0000000000000000}, // 0 * n
    {OP(0, 0, 2, 0, 3, 1), 0x00000001, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000000, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000001, 0x00000001, 0x0123456789ABCDEF, 0x0000000000000001}, // 1 * n
    {OP(0, 0, 2, 0, 3, 1), 0x00000001, 0x7FFFFFFF, 0x0123456789ABCDEF, 0x000000007FFFFFFF},
    {OP(0, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0x00000001, 0x0123456789ABCDEF, 0x000000007FFFFFFF},
    {OP(0, 0, 2, 0, 3, 1), 0x00000001, 0x80000000, 0x0123456789ABCDEF, 0xFFFFFFFF80000000},
    {OP(0, 0, 2, 0, 3, 1), 0x80000000, 0x00000001, 0x0123456789ABCDEF, 0xFFFFFFFF80000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000001, 0xFFFFFFFF, 0x0123456789ABCDEF, 0xFFFFFFFFFFFFFFFF},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000001, 0x0123456789ABCDEF, 0xFFFFFFFFFFFFFFFF},
    {OP(0, 0, 2, 0, 3, 1), 0x00000002, 0x30000000, 0x0123456789ABCDEF, 0x0000000060000000}, // 2 * n
    {OP(0, 0, 2, 0, 3, 1), 0x30000000, 0x00000002, 0x0123456789ABCDEF, 0x0000000060000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000002, 0x40000000, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(0, 0, 2, 0, 3, 1), 0x40000000, 0x00000002, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000002, 0x7FFFFFFF, 0x0123456789ABCDEF, 0x00000000FFFFFFFE},
    {OP(0, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0x00000002, 0x0123456789ABCDEF, 0x00000000FFFFFFFE},
    {OP(0, 0, 2, 0, 3, 1), 0x00000002, 0x80000000, 0x0123456789ABCDEF, 0xFFFFFFFF00000000},
    {OP(0, 0, 2, 0, 3, 1), 0x80000000, 0x00000002, 0x0123456789ABCDEF, 0xFFFFFFFF00000000},
    {OP(0, 0, 2, 0, 3, 1), 0x00000002, 0xFFFFFFFF, 0x0123456789ABCDEF, 0xFFFFFFFFFFFFFFFE},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000002, 0x0123456789ABCDEF, 0xFFFFFFFFFFFFFFFE},
    {OP(0, 0, 2, 0, 3, 1), 0x00000003, 0x30000000, 0x0123456789ABCDEF, 0x0000000090000000}, // 3 * n
    {OP(0, 0, 2, 0, 3, 1), 0x30000000, 0x00000003, 0x0123456789ABCDEF, 0x0000000090000000},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x7FFFFFFF, 0x0123456789ABCDEF, 0xFFFFFFFF80000001}, // -1 * n
    {OP(0, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x0123456789ABCDEF, 0xFFFFFFFF80000001},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x80000000, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(0, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(0, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x0000000000000001},
    {OP(0, 0, 2, 0, 3, 1), 0x01234567, 0x89ABCDEF, 0x0123456789ABCDEF, 0xFF795E36C94E4629}, // extras
    {OP(0, 0, 2, 0, 3, 1), 0x89ABCDEF, 0x01234567, 0x0123456789ABCDEF, 0xFF795E36C94E4629},

    // UMULL r0 r3 r2 r1
    {OP(2, 0, 2, 0, 3, 1), 0x00000000, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000}, // 31
    {OP(2, 0, 2, 0, 3, 1), 0x00000000, 0x00000001, 0x0123456789ABCDEF, 0x0000000000000000}, // 0 * n
    {OP(2, 0, 2, 0, 3, 1), 0x00000001, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000000, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000000, 0x0123456789ABCDEF, 0x0000000000000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000001, 0x00000001, 0x0123456789ABCDEF, 0x0000000000000001}, // 1 * n
    {OP(2, 0, 2, 0, 3, 1), 0x00000001, 0x7FFFFFFF, 0x0123456789ABCDEF, 0x000000007FFFFFFF},
    {OP(2, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0x00000001, 0x0123456789ABCDEF, 0x000000007FFFFFFF},
    {OP(2, 0, 2, 0, 3, 1), 0x00000001, 0x80000000, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(2, 0, 2, 0, 3, 1), 0x80000000, 0x00000001, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000001, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x00000000FFFFFFFF},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000001, 0x0123456789ABCDEF, 0x00000000FFFFFFFF},
    {OP(2, 0, 2, 0, 3, 1), 0x00000002, 0x30000000, 0x0123456789ABCDEF, 0x0000000060000000}, // 2 * n
    {OP(2, 0, 2, 0, 3, 1), 0x30000000, 0x00000002, 0x0123456789ABCDEF, 0x0000000060000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000002, 0x40000000, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(2, 0, 2, 0, 3, 1), 0x40000000, 0x00000002, 0x0123456789ABCDEF, 0x0000000080000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000002, 0x7FFFFFFF, 0x0123456789ABCDEF, 0x00000000FFFFFFFE},
    {OP(2, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0x00000002, 0x0123456789ABCDEF, 0x00000000FFFFFFFE},
    {OP(2, 0, 2, 0, 3, 1), 0x00000002, 0x80000000, 0x0123456789ABCDEF, 0x0000000100000000},
    {OP(2, 0, 2, 0, 3, 1), 0x80000000, 0x00000002, 0x0123456789ABCDEF, 0x0000000100000000},
    {OP(2, 0, 2, 0, 3, 1), 0x00000002, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x00000001FFFFFFFE},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x00000002, 0x0123456789ABCDEF, 0x00000001FFFFFFFE},
    {OP(2, 0, 2, 0, 3, 1), 0x00000003, 0x30000000, 0x0123456789ABCDEF, 0x0000000090000000}, // 3 * n
    {OP(2, 0, 2, 0, 3, 1), 0x30000000, 0x00000003, 0x0123456789ABCDEF, 0x0000000090000000},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x7FFFFFFF, 0x0123456789ABCDEF, 0x7FFFFFFE80000001}, // -1 * n
    {OP(2, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x7FFFFFFE80000001},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x80000000, 0x0123456789ABCDEF, 0x7FFFFFFF80000000},
    {OP(2, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x0123456789ABCDEF, 0x7FFFFFFF80000000},
    {OP(2, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x0123456789ABCDEF, 0xFFFFFFFE00000001},
    {OP(2, 0, 2, 0, 3, 1), 0x01234567, 0x89ABCDEF, 0x0123456789ABCDEF, 0x009CA39DC94E4629}, // extras
    {OP(2, 0, 2, 0, 3, 1), 0x89ABCDEF, 0x01234567, 0x0123456789ABCDEF, 0x009CA39DC94E4629},

    // SMLAL r0 r2 r3
    {OP(4, 0, 2, 0, 3, 1), 0x00000000, 0x00000000, 0x0000000000000000, 0x0000000000000000}, // 62
    {OP(4, 0, 2, 0, 3, 1), 0x00000000, 0x00000001, 0x0000000000000000, 0x0000000000000000}, // 0 * n
    {OP(4, 0, 2, 0, 3, 1), 0x00000001, 0x00000000, 0x0000000000000000, 0x0000000000000000},
    {OP(4, 0, 2, 0, 3, 1), 0x00000001, 0x00000000, 0x
FFFFFF},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x7FFFFFFF, 0x0000000000000000, 0x7FFFFFFE80000001}, // -1 * n
    {OP(6, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x0000000000000000, 0x7FFFFFFE80000001},
    {OP(6, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x0000000000000001, 0x7FFFFFFE80000002},
    {OP(6, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x7FFFFFFFFFFFFFFF, 0xFFFFFFFE80000000},
    {OP(6, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x8000000000000000, 0xFFFFFFFE80000001},
    {OP(6, 0, 2, 0, 3, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0x7FFFFFFE80000000},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0x80000000, 0x0000000000000000, 0x7FFFFFFF80000000},
    {OP(6, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x0000000000000000, 0x7FFFFFFF80000000},
    {OP(6, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x0000000000000001, 0x7FFFFFFF80000001},
    {OP(6, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x7FFFFFFFFFFFFFFF, 0xFFFFFFFF7FFFFFFF},
    {OP(6, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0x8000000000000000, 0xFFFFFFFF80000000},
    {OP(6, 0, 2, 0, 3, 1), 0x80000000, 0xFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0x7FFFFFFF7FFFFFFF},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x0000000000000000, 0xFFFFFFFE00000001},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x0000000000000001, 0xFFFFFFFE00000002},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFFFFFFFFFF, 0x7FFFFFFE00000000},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x8000000000000000, 0x7FFFFFFE00000001},
    {OP(6, 0, 2, 0, 3, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFE00000000},
    {OP(6, 0, 2, 0, 3, 1), 0x01234567, 0x89ABCDEF, 0x0000000000000000, 0x009CA39DC94E4629}, // extras
    {OP(6, 0, 2, 0, 3, 1), 0x89ABCDEF, 0x01234567, 0x0000000000000000, 0x009CA39DC94E4629},
    {OP(6, 0, 2, 0, 3, 1), 0x89ABCDEF, 0x01234567, 0xFEDCBA9876543210, 0xFF795E363FA27839},
    {OP(6, 0, 2, 0, 3, 1), 0x89ABCDEF, 0x01234567, 0x0123456789ABCDEF, 0x01BFE90552FA1418},
};

#undef OP

static const int num_mull_tests = sizeof(mull_tests) / sizeof(mull_tests[0]);

// divide
// divide by 0 may trap, we're assuming that is disabled
#define OP(op, op2, rn, rd, rm) (0xFB80F000 | op << 20 | rn << 16 | rd << 8 | op2 << 4 | rm)

static const struct TestInfo32 div_tests[] = {
    // SDIV r0 r2 r1
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x00000000, 0x00000000, 0, 0}, // 0
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x01234567, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x80000000, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000000, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000000, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x00000000, 0x00000000, 0, 0}, // 7
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x00000001, 0x00000001, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x01234567, 0x01234567, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x7FFFFFFF, 0x7FFFFFFF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x80000000, 0x80000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0x89ABCDEF, 0x89ABCDEF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000001, 0xFFFFFFFF, 0xFFFFFFFF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x00000000, 0x00000000, 0, 0}, // 14
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x01234567, 0x0091A2B3, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x7FFFFFFF, 0x3FFFFFFF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x80000000, 0xC0000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0x89ABCDEF, 0xC4D5E6F8, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000002, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x00000000, 0x00000000, 0, 0}, // 21
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x01234567, 0x003A4114, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x7FFFFFFF, 0x19999999, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x80000000, 0xE6666667, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0x89ABCDEF, 0xE8558F97, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x00000005, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x00000000, 0x00000000, 0, 0}, // 28
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x01234567, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x7FFFFFFF, 0x00000001, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x80000000, 0xFFFFFFFF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x00000000, 0x00000000, 0, 0}, // 35
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x01234567, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x80000000, 0x00000001, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0x80000000, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x00000000, 0x00000000, 0, 0}, // 42
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x00000001, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x01234567, 0xFFE58554, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x7FFFFFFF, 0xF45D1746, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x80000000, 0x0BA2E8BA, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0x89ABCDEF, 0x0AC1D601, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFF5, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0}, // 49
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x00000001, 0xFFFFFFFF, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x01234567, 0xFEDCBA99, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x7FFFFFFF, 0x80000001, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x80000000, 0x80000000, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0x89ABCDEF, 0x76543211, 0, 0},
    {OP(1, 15, 2, 0, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x00000001, 0, 0},

    // UDIV r0 r2 r1
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x00000000, 0x00000000, 0, 0}, // 56
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x01234567, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x80000000, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000000, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000000, 0xFFFFFFFF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x00000000, 0x00000000, 0, 0}, // 63
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x00000001, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x01234567, 0x01234567, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x7FFFFFFF, 0x7FFFFFFF, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x80000000, 0x80000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0x89ABCDEF, 0x89ABCDEF, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000001, 0xFFFFFFFF, 0xFFFFFFFF, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x00000000, 0x00000000, 0, 0}, // 70
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x01234567, 0x0091A2B3, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x7FFFFFFF, 0x3FFFFFFF, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x80000000, 0x40000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0x89ABCDEF, 0x44D5E6F7, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000002, 0xFFFFFFFF, 0x7FFFFFFF, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x00000000, 0x00000000, 0, 0}, // 77
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x01234567, 0x003A4114, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x7FFFFFFF, 0x19999999, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x80000000, 0x19999999, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0x89ABCDEF, 0x1B88C2C9, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x00000005, 0xFFFFFFFF, 0x33333333, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x00000000, 0x00000000, 0, 0}, // 84
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x01234567, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x7FFFFFFF, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x80000000, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0x89ABCDEF, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x7FFFFFFF, 0xFFFFFFFF, 0x00000002, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x00000000, 0x00000000, 0, 0}, // 91
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x01234567, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x80000000, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0x89ABCDEF, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0x80000000, 0xFFFFFFFF, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x00000000, 0x00000000, 0, 0}, // 98
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x01234567, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x80000000, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFF5, 0xFFFFFFFF, 0x00000001, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0}, // 105
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x00000001, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x01234567, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x7FFFFFFF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x80000000, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0x89ABCDEF, 0x00000000, 0, 0},
    {OP(3, 15, 2, 0, 1), 0xFFFFFFFF, 0xFFFFFFFF, 0x00000001, 0, 0},
};

#undef OP

static const int num_div_tests = sizeof(div_tests) / sizeof(div_tests[0]);
...
// 64-bit dest and possibly src
static bool run_thumb2_long_mul_tests(GroupCallback group_cb, FailCallback fail_cb, const struct TestInfo32LongMul *tests, int num_tests, const char *label, int dest, int dest_hi) {
    ...
    for(int i = 0; i < num_tests; i++) {
        const struct TestInfo32LongMul *test = &tests[i];
        ...
        *ptr++ = test->opcode;
        ...
        if(dest_hi != 1)
            *ptr++ = dest_hi << 3 | 1; // mov r1 rN
        
        *ptr++ = 0x4770; // BX LR

        TestFunc64 func64 = (TestFunc64)((uintptr_t)code_buf | 1);
        invalidate_icache();

        uint64_t out = func64(test->a_in, test->m_in, test->n_in, test->a_in >> 32);

        if(out != test->d_out) {
            res = false;
            if(out << 32 != test->d_out << 32) // low
                fail_cb(i, out, test->d_out);

            if(out >> 32 != test->d_out >> 32) // high
                fail_cb(i, out >> 32, test->d_out >> 32);
        }
        ...
        TestFunc func = (TestFunc)((uintptr_t)code_buf | 1);
        invalidate_icache();
        out = func(PSR_VCZN, test->m_in, test->n_in, test->a_in >> 32);
        out &= PSR_MASK;
...
bool run_thumb2_data_processing_tests(GroupCallback group_cb, FailCallback fail_cb) {
    ...
    ret = run_thumb2_long_mul_tests(group_cb, fail_cb, mull_tests, num_mull_tests, "mull", 0, 3) && ret;

    ret = run_thumb2_mul_div_tests(group_cb, fail_cb, div_tests, num_div_tests, "div", 0) && ret;
